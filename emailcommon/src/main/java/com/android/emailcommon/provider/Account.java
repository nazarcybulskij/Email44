...
public final class Account extends EmailContent implements AccountColumns, Parcelable {
     ...
     * {@code content://com.android.email_ee.provider/account/UUID} format, which is safe to use
    ...
    /**
     * Parse {@link Uri} in the {@code content://com.android.email_ee.provider/account/ID} format
