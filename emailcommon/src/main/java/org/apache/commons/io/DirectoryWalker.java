 ...
 * <ul>
 *    <li>{@link org.apache.commons.io.DirectoryWalker.CancelException} which can be thrown in any of the
 *        <i>lifecycle</i> methods to stop processing.</li>
 *    <li>The <code>walk()</code> method traps thrown {@link org.apache.commons.io.DirectoryWalker.CancelException}
 ...
 *    <li>Constructing and throwing a {@link org.apache.commons.io.DirectoryWalker.CancelException}.</li>
 ...
 * <b>Note</b> the decision logic and throwing a {@link org.apache.commons.io.DirectoryWalker.CancelException} could be implemented
...
public abstract class DirectoryWalker {
     ...
     * part of the walk. The {@link org.apache.commons.io.filefilter.FileFilterUtils} class is useful for combining
     ...
     * of the walk. This constructor uses {@link org.apache.commons.io.filefilter.FileFilterUtils#makeDirectoryOnly(org.apache.commons.io.filefilter.IOFileFilter)}
     * and {@link org.apache.commons.io.filefilter.FileFilterUtils#makeFileOnly(org.apache.commons.io.filefilter.IOFileFilter)} internally to combine the filters.
     ...
     * <p>
     * This implementation just re-throws the {@link org.apache.commons.io.DirectoryWalker.CancelException}.
     *
