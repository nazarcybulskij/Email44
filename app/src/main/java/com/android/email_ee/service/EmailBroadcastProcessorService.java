...
package com.android.email_ee.service;
...
import com.android.email_ee.SecurityPolicy;
import com.android.email_ee.activity.setup.AccountSettings;
import com.android.email_ee.provider.AccountReconciler;
...
public class EmailBroadcastProcessorService extends IntentService {
    ...
    /**
     * Entry point for {@link com.android.email_ee.SecurityPolicy.PolicyAdmin}.  These will
     * simply callback to {@link
     * com.android.email_ee.SecurityPolicy#onDeviceAdminReceiverMessage(Context, int)}.
     */
