...
public class KeyListActivity extends DrawerActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (i == R.id.menu_key_list_add) {
            ...
            return true;
        } else if (i == R.id.menu_key_list_search_cloud) {
            searchCloud();
            return true;
        } else if (i == R.id.menu_key_list_create) {
            createKey();
            return true;
        } else if (i == R.id.menu_key_list_import_existing_key) {
            ...
            return true;
        } else if (i == R.id.menu_key_list_export) {
            mExportHelper.showExportKeysDialog(null, Constants.Path.APP_DIR_FILE, true);
            return true;
        } else if (i == R.id.menu_key_list_debug_cons) {
            consolidate();
            return true;
        } else if (i == R.id.menu_key_list_debug_read) {
            try {
            ...
            return true;
        } else if (i == R.id.menu_key_list_debug_write) {
            try {
            ...
            return true;
        } else if (i == R.id.menu_key_list_debug_first_time) {
            Preferences prefs = Preferences.getPreferences(this);
